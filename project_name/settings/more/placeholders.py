...
CMS_PLACEHOLDER_CONF = {
    ...
    'content': {
        "plugins": ['MultiLineTitlePlugin','ImageTextPlugin', 'GalleryPlugin', 'TextPlugin', 'IframePlugin', 'AccordionPlugin', 'FormPlugin', 'AccordionEntryPlugin', 'OfferPlugin', 'RoomOfferPlugin'],
